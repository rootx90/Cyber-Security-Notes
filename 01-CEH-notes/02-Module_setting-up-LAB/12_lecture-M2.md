...
### Types of I.G ?
- 1st : Active & 2nd : Passive <br>![[12_lecture-0-M2.jpg | 500]]
- in Active I.G , for Eg : 
	- u're asking from Kate about ally for information like where she live , her address , <br>etc.
...
- in Passive I.G , For Eg : 
	- gathering information without interacting - means Victim didn't know that u're collecting Information <br>about her/him - like going social media of Victim , etc.
- Ques : u're getting information about that person from his/her Linkedin profile , so is it Active or Passive I.G<br>Ans : that's Active I.G , cuz when u view that person's Linkedin profile then Linkedin will send the notification <br>to that person about "This is a person who viewed ur profile" <br>- `imp Note ⭐` :  any information which make Victim aler/aware or Victim now knows about it <br>then it'll be Active I.G , not passive ✔
- Ques : Information Gathering Practical did on WsCubeTech , is it Active or Passive I.G <br>Ans : that was Passive I.G 99% <br>- Mine thought - for 1% was Active cuz u visited on linkedin & linkedin will notify to Victim who visited
...
2. Easy Processing
3. Accurate Attacking <br>- cuz we done the main thing i.e Information Gathering <br>- due to which system got hacked
...
- here we'll see 2nd source i.e Google Dorks/operators (means Google Hacking Advance Techniques)
	...
	- in `allintext:` & `intext:` : 
		- `intext:` : means in text form
			...
			- Eg : search `intext:wscubetech` & anywhere in search results "wscubetech" written in text form <br>those results will be shown <br>![](12_lecture-4-M2.jpg)
		- `allintext:` : means all in text form
			...
			- Eg : search `allintext:wscubetech devendra hacker` <br>![](12_lecture-5-M2.jpg)
			- in output , hacking word also coming cuz hacker word used
	- in `allinurl:` & `inurl:`
		- `inurl:` : it takes only single word
			- Eg : `inurl:wscubetech` - so those search results will be shown whose have "wscubetech" <br>in their URL <br>![](12_lecture-6-M2.jpg)
		- `allinurl:` : it can single or multiple words
			- Eg : `allinurl:wscubetech youtube facebook` , those results will be shown whose have <br>if any one or all these 3 words come in URL <br>![](12_lecture-7-M2.jpg)
	-  in `intitle:` & `allintitle:`
		- `intitle:` : means showing a word in title (means the tab name (of the browser))
			- it takes only one word
			- Eg : `intitle:facebook` <br>![](12_lecture-8-M2.jpg)
	...
	- in `site:` : 
		- means Eg : `site:wscubetech.com` - only those results will be shown which are only related to wscubetech.com ,<br>no other websites links will come as outputs ✔<br>![](12_lecture-9-M2.jpg)
	- `-` : means minus sign
	...
	- `*` operator :
		...
		- usecase of it - let's say u know half word of that complete word - but u forgot half word of it <br>Eg 2 : `devendra` - but u don't know sir name of the name , so put star sign - `devendra*` <br>![](12_lecture-10-M2.jpg)
	- `indexof:`
		- Story
			- Ques : can we access files & folders from a computer of any client <br>Ans : No , any client can access their own computer not others
			- so a developer when make a website then that website contain files & folders <br>& they extract that website & kept files + folders on a server <br>Ques : can we access/see files & folders of a website of a developer <br>Ans : no , cuz they are private
		...
		- Examples 
			- Eg 1 : `indexof:facebook.com` <br>- so anything which is running connectivity of facebook but their server has vulnerability of `Directory Traversal` ✔ <br>![](12_lecture-11-M2.jpg) <br>- files & folders <br>![](12_lecture-12-M2.jpg)
...
1. Advice : clear ur doubts during lecture, cuz taking ur doubts at home is like baggage <br>if u're getting any doubt in ur mind during lecture then clear it right now <br>otherwise if u're not getting doubt during lecture then it's fine ✔
2. Advice - Ques : can i get the PPT via which Sir Explain <br>Ans : those PPT are not useful cuz only points are written in those PPT <br>so make ur own self-notes , so these PPT are useless & in future , u'll get many books to read