...
- Types of scan are : 
	- 1st scan that we run : TCP i.e `-sT`
		...
		- Q : how TCP will find/scan which Ports are open & which are not of an IP-address/system <br>Ans : Ques - how many ways that TCP do handshake/communication ? <br>- in lecture 4 , we learned about three-way handshake communication by TCP ✔
	...
	- 2nd scan : SYN scan i.e `-sS`
		...
		- so the scan which we run from "A" to "B" system & "B" to "A" system <br>aka SYN scan or half open scan or stealth scan i.e in nmap = `-sS` ✔ <br><img src="../notes-pics/03-Module/14_lecture/14_lecture-5-M3.jpg" alt="" width="500"/>
...
- Q : define IDS <br>Ans : https://www.perplexity.ai/search/IDS-means-in-V3I2A5_jSaCEi.VnqiyB5w
